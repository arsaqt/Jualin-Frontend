                                ...
                                <tbody>
                                    <tr>
                                        <td class="product__thumbnail">
                                            <a href="#">
                                                <img src="{{asset('jualin/images/products/iPhone/iphone6.jpeg')}}" alt="">
                                            </a>
                                        </td>
                                            ...
                                            <div class="input-counter">
                                                <div>
                                                    <span class="minus-btn">
                                                        <svg>
                                                            <use xlink:href="{{asset('jualin/images/sprite.svg#icon-minus')}}"></use>
                                                        </svg>
                                                    </span>
                                                    <input type="text" min="1" value="1" max="10" class="counter-btn">
                                                    <span class="plus-btn">
                                                        <svg>
                                                            <use xlink:href="{{asset('jualin/images/sprite.svg#icon-plus')}}"></use>
                                                        </svg>
                                                    </span>
                                                </div>
                                            </div>
                                        ...
                                        <td class="product__subtotal">
                                            ...
                                            <a href="#" class="remove__cart-item">
                                                <svg>
                                                    <use xlink:href="{{asset('jualin/images/sprite.svg#icon-trash')}}"></use>
                                                </svg>
                                            </a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="product__thumbnail">
                                            <a href="#">
                                                <img src="{{asset('jualin/images/products/sumsung/samsung5.jpeg')}}" alt="">
                                            </a>
                                        </td>
                                        <td class="product__name">
                                            <a href="#">Apple iPhone 11</a>
                                    ...
                                    <tr>
                                        <td class="product__thumbnail">
                                            <a href="#">
                                                <img src="{{asset('jualin/images/products/sumsung/samsung2.jpeg')}}" alt="">
                                            </a>
                                        </td>
                                        <td class="product__name">
                                            <a href="#">Apple iPhone 11</a>
                                    ...
                                    <tr>
                                        <td class="product__thumbnail">
                                            <a href="#">
                                                <img src="{{asset('jualin/images/products/iPhone/iphone4.jpeg')}}" alt="">
                                            </a>
                                        </td>
                                        <td class="product__name">
                                            <a href="#">Apple iPhone 11</a>
                ...
                <div class="facility__contianer">
                    <div class="facility__box">
                        <div class="facility-img__container">
                            <svg>
                                <use xlink:href="{{asset('jualin/images/sprite.svg#icon-airplane')}}"></use>
                            </svg>
                        </div>
                    ...
                    <div class="facility__box">
                        <div class="facility-img__container">
                            <svg>
                                <use xlink:href="{{asset('jualin/images/sprite.svg#icon-credit-card-alt')}}"></use>
                            </svg>
                        </div>
                    ...
                    <div class="facility__box">
                        <div class="facility-img__container">
                            <svg>
                                <use xlink:href="{{asset('jualin/images/sprite.svg#icon-credit-card')}}"></use>
                            </svg>
                        </div>
                    ...
                    <div class="facility__box">
                        <div class="facility-img__container">
                            <svg>
                                <use xlink:href="{{asset('jualin/images/sprite.svg#icon-headphones')}}"></use>
                            </svg>
                        </div>
